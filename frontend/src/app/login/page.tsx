      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 lg:p-20 border-r border-[#1e293b]">
        ...
        <div className="max-w-md">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            Log in to access your meetings, recordings, and team dashboard.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md bg-[#111520] border border-[#1e293b] rounded-3xl p-8 sm:p-10 shadow-2xl">
          ...
          <div className="mt-8 mb-6 flex items-center justify-center">
            ...
            <span className="px-4 text-xs font-bold tracking-widest text-gray-500 uppercase">Or Continue With</span>
            <div className="h-px bg-[#1e293b] flex-1"></div>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
            Don't have an account? <Link href="/signup" className="text-blue-500 hover:text-blue-400 font-semibold transition-colors">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
